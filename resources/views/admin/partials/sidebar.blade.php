<div class="sidebar py-3" id="sidebar">
    ...
    <ul class="list-unstyled">
        ...
        <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#">
                <span class="sidebar-link-title">View Work Details </span></a>
        </li>
        <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#">
                <span class="sidebar-link-title">Manage Leave </span></a>
        </li>
        <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#">
                <span class="sidebar-link-title">Manage Tour </span></a>
        </li>
        <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#">
                <span class="sidebar-link-title">Payroll Management</span></a>
        </li>
        <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#">
                <span class="sidebar-link-title">Time Management</span></a>
        </li>
    </ul>
